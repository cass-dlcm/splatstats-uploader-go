...
type BattleStatInk struct {
				...
				Gachi struct {
					...
					Rules       struct {
						Area struct {
							...
							XPowerPeak    interface{} `json:"x_power_peak"`
							XPowerCurrent interface{} `json:"x_power_current"`
						} `json:"area"`
						Yagura struct {
							RankPeak      string      `json:"rank_peak"`
							RankCurrent   string      `json:"rank_current"`
	...
	RankExp   interface{} `json:"rank_exp"`
	RankAfter struct {
		Key  string `json:"key"`
		Zone struct {
			Key  string `json:"key"`
	...
	RankExpAfter               interface{}   `json:"rank_exp_after"`
	XPower                     interface{}   `json:"x_power"`
	XPowerAfter                interface{}   `json:"x_power_after"`
	EstimateXPower             interface{}   `json:"estimate_x_power"`
	...
	MaxKillCombo               interface{}   `json:"max_kill_combo"`
	MaxKillStreak              interface{}   `json:"max_kill_streak"`
	...
	HisTeamPoint               interface{}   `json:"his_team_point"`
	MyTeamPercent              *string       `json:"my_team_percent"`
	...
	HisTeamFestTheme               interface{} `json:"his_team_fest_theme"`
	MyTeamNickname                 interface{} `json:"my_team_nickname"`
	HisTeamNickname                interface{} `json:"his_team_nickname"`
	Clout                          interface{} `json:"clout"`
	TotalClout                     interface{} `json:"total_clout"`
	TotalCloutAfter                interface{} `json:"total_clout_after"`
	MyTeamWinStreak                interface{} `json:"my_team_win_streak"`
	HisTeamWinStreak               interface{} `json:"his_team_win_streak"`
	SynergyBonus                   interface{} `json:"synergy_bonus"`
	SpecialBattle                  interface{} `json:"special_battle"`
	ImageJudge                     interface{} `json:"image_judge"`
	ImageResult                    string      `json:"image_result"`
	ImageGear                      interface{} `json:"image_gear"`
	Gears                          struct {
		Headgear struct {
			Gear struct {
				Key  string `json:"key"`
	...
	Players     []struct {
		...
		Weapon struct {
			...
			ReskinOf    interface{} `json:"reskin_of"`
			MainRef     string      `json:"main_ref"`
			MainPowerUp struct {
				Key  string `json:"key"`
				Name struct {
	...
	Agent        struct {
		Name            string      `json:"name"`
		Version         string      `json:"version"`
		GameVersion     interface{} `json:"game_version"`
		GameVersionDate interface{} `json:"game_version_date"`
	...
	NawabariBonus interface{} `json:"nawabari_bonus"`
	StartAt       struct {
		Time    int       `json:"time"`
		Iso8601 time.Time `json:"iso8601"`
	} `json:"start_at"`
